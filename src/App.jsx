...
function App() {
  ...
  return (
    <>
      ...
      <Routes>
        <Route path="/home" element={<UeberMich onClick={closeMobileMenuIfOpen}/>}/>
        <Route path="/texte" element={<Texte onClick={closeMobileMenuIfOpen}/>}/>
        <Route path="/blog" element={<Blog onClick={closeMobileMenuIfOpen}/>}/>
        <Route path="/resume" element={<Resume onClick={closeMobileMenuIfOpen}/>}/>
        <Route path="/kontakt" element={<Kontakt onClick={closeMobileMenuIfOpen}/>}/>
