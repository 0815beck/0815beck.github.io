function UeberMich({onClick}) {
  return (
    <main className="w-full flex-grow overflow-auto bg-violet-50" onClick={onClick}>
    <section className="mx-auto max-w-4xl px-4 py-6">
        <h1 className="font-bold mb-2 px-3 py-2  bg-violet-200 drop-shadow-sm"> Über mich</h1>
        <p className="mb-2 px-3 py-2 bg-violet-100 drop-shadow-sm">
